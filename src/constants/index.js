...
export const frame1 = [
  {
    ...
    Header: "Homyz",
    details:
      "I contributed to Westway World's frontend development, creating a user-friendly platform for global youth. It enables users to discover WestWay company's upcoming events and conveniently buy event-related merchandise. Leveraging ReactJS, I integrated dynamic functionalities, while MaterialUI ensured seamless and responsive designs.",
